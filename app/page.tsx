  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <section className="mb-10">
        <h1 className="text-pretty text-3xl font-semibold text-foreground">
          Code. Physics. The Beautiful Game. Deconstructed.
        </h1>
        <p className="mt-3 max-w-prose text-sm leading-7 text-foreground/75">
      ...
      <section>
        <h2 className="mb-3 text-xl font-semibold text-foreground">Latest</h2>
